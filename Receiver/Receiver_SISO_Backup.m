function [ Symbol_stream_Rx ] = Receiver(Signal_Rx,Fs,OFDM_config,IF_chain_config,Simulation_config,Testing_data )
...
%OFDM_Ref_symbol_Tx_f=OFDM_config.OFDM_Ref_symbol_Tx_f;
%Pilots_matrix_Tx=OFDM_config.Pilots_matrix_Tx;
T=OFDM_config.T;
...
if Time_sync_flag
    ...
    OFDM_matrix_Rx_f=OFDM_matrix_Rx_f./H_est_mat; % the equalization operation
